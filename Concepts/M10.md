...
OK, let's have a look at some [cource code](https://github.com/oniondeluxe/Public/blob/master/Concepts/Code/NarrationTests.cs), which is a unit test for the code that emits meta data for the classes that will materialize as entries in the catalog that has been setup from an Xaml source.  
Just to illustrate the ballpark magnitude and complexity. Feel free to abandon, at your own discretion.  