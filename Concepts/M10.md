...
This is where you start, when you want to either write new software from scratch, or when modifying existing software to start taking advantage of M10.  

You will go into the M10 modeling environment, using your M10 user account. An extensive access rights infrastructurte will define who can work with what.  
