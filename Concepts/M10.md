...
The guiding principles for how M10 is built, lie around the principle of divide and conquer, and to stay agnostic around alignment with specific domains. So, to illustrate one of the characteristics of these principles, let's look at an example from some accounting software, and with a particular aspect i mind – abstraction levels. 
